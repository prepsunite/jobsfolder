...
VALUES
  ...
  ('hashing-frequency', 'PROGRAMMING_150', 'ARRAYS', '1D Arrays: Hashing & Frequency Maps', 'Stage 4: 1D Arrays', 'Direct-index frequency arrays, HashMap lookups, Two Sum in O(N), first non-repeating element, and prefix map lookups.', 'Database', 10, false),
  ('matrices-grid', 'PROGRAMMING_150', 'ARRAYS', '2D Arrays & Matrix Mathematics', 'Stage 5: Matrices & Strings', 'Matrix multiplication, in-place transpose, 90° clockwise rotation, and spiral boundary traversal.', 'Grid', 11, false),
  ('strings-basics', 'PROGRAMMING_150', 'STRINGS', 'String Fundamentals & ASCII Scans', 'Stage 5: Matrices & Strings', 'Case toggle, vowel/consonant counter, space removal, and ASCII character arithmetic.', 'Type', 12, false),
  ('strings-palindromes', 'PROGRAMMING_150', 'STRINGS', 'Palindromes, Anagrams & Frequency Maps', 'Stage 5: Matrices & Strings', 'Two-pointer palindrome verification, 26-element alphabet frequency hash, and anagram detection.', 'Sparkles', 13, false),
  ('strings-word-parsing', 'PROGRAMMING_150', 'STRINGS', 'Word Parsing & Token Manipulation', 'Stage 5: Matrices & Strings', 'Sentence word count, in-place word reversal, longest word identification, and Run-Length Encoding.', 'Type', 14, false),
  ('recursion-backtracking', 'PROGRAMMING_150', 'RECURSION', 'Recursion & Backtracking Fundamentals', 'Stage 6: Recursion & Advanced', 'Base condition termination, call stack tracing, subset generation, and Tower of Hanoi recursion.', 'Cpu', 15, false),
  ('searching-sorting', 'PROGRAMMING_150', 'SEARCHING_SORTING', 'Searching & Sorting Essentials', 'Stage 6: Recursion & Advanced', 'Binary Search on sorted space, Bubble/Insertion/Selection Sort, and Merge/Quick Sort partition logic.', 'Search', 16, false),
  ('bit-manipulation', 'PROGRAMMING_150', 'BIT_MANIPULATION', 'Bit Manipulation & Low-Level Math', 'Stage 6: Recursion & Advanced', 'Power of 2 check via (n & (n-1)), single non-repeating element using XOR, and Brian Kernighan''s algorithm.', 'Binary', 17, false)
