...
export const FALLBACK_APTITUDE_TOPICS = [
  ...
  { id: 'geometry-theorems', name: 'Geometry & Polygons', category_slug: 'arithmetic-aptitude' },
  ...
  { id: 'coordinate-geometry', name: 'Coordinate Geometry', category_slug: 'arithmetic-aptitude' },
  { id: 'trigonometry', name: 'Trigonometry & Identities', category_slug: 'arithmetic-aptitude' },
  { id: 'algebra-quadratic-equations', name: 'Algebra & Quadratic Equations', category_slug: 'arithmetic-aptitude' },
  { id: 'progressions-ap-gp-hp', name: 'Progressions (AP, GP, HP)', category_slug: 'arithmetic-aptitude' },
  { id: 'set-theory', name: 'Set Theory & Venn Math', category_slug: 'arithmetic-aptitude' },
  ...
  { id: 'surds-indices', name: 'Surds and Indices', category_slug: 'arithmetic-aptitude' },
  ...
  { id: 'caselet-di', name: 'Caselet & Mixed DI', category_slug: 'data-interpretation' },
  { id: 'missing-di', name: 'Missing Data Interpretation', category_slug: 'data-interpretation' },
  { id: 'radar-web-charts', name: 'Radar & Spider Web Charts', category_slug: 'data-interpretation' },
  ...
  { id: 'cryptarithmetic', name: 'Cryptarithmetic (Alphametics)', category_slug: 'logical-reasoning' },
  { id: 'machine-input-output', name: 'Machine Input-Output', category_slug: 'logical-reasoning' },
  { id: 'inequalities', name: 'Mathematical & Coded Inequalities', category_slug: 'logical-reasoning' },
  { id: 'order-and-ranking', name: 'Order and Ranking', category_slug: 'logical-reasoning' },
  { id: 'floor-scheduling-puzzles', name: 'Floor & Scheduling Puzzles', category_slug: 'logical-reasoning' },
  { id: 'games-and-tournaments', name: 'Games and Tournaments', category_slug: 'logical-reasoning' },
  { id: 'truth-tellers-liars', name: 'Truth-Tellers and Liars', category_slug: 'logical-reasoning' },
  { id: 'eligibility-test', name: 'Eligibility Test & Decision Making', category_slug: 'logical-reasoning' },
  ...
  { id: 'vr-seating-arrangement', name: 'Seating Arrangement', category_slug: 'verbal-reasoning' },
  { id: 'vr-direction-sense', name: 'Direction Sense Test', category_slug: 'verbal-reasoning' },
  { id: 'vr-dice-cube', name: 'Dice, Cube and Cuboid', category_slug: 'verbal-reasoning' },
  { id: 'vr-logical-sequence', name: 'Logical Sequence of Words', category_slug: 'verbal-reasoning' },
  { id: 'series-completion', name: 'Series Completion', category_slug: 'verbal-reasoning' },
  { id: 'character-puzzles', name: 'Character Puzzles', category_slug: 'verbal-reasoning' },
  { id: 'classification', name: 'Classification', category_slug: 'verbal-reasoning' },
  { id: 'vr-analogy', name: 'Analogy', category_slug: 'verbal-reasoning' },
  { id: 'vr-syllogism', name: 'Syllogisms & Premises', category_slug: 'verbal-reasoning' },
  { id: 'venn-diagrams', name: 'Venn Diagrams', category_slug: 'verbal-reasoning' },
  { id: 'vr-cause-effect', name: 'Cause & Effect Analysis', category_slug: 'verbal-reasoning' },
  { id: 'data-sufficiency', name: 'Data Sufficiency', category_slug: 'verbal-reasoning' },
  { id: 'arithmetic-reasoning', name: 'Arithmetic Reasoning', category_slug: 'verbal-reasoning' },
  { id: 'verification-of-truth', name: 'Verification of Truth', category_slug: 'verbal-reasoning' },
  { id: 'assertion-and-reason', name: 'Assertion and Reason', category_slug: 'verbal-reasoning' },
  { id: 'statement-and-inferences', name: 'Statement and Inferences', category_slug: 'verbal-reasoning' },
  ...
  { id: 'confusing-words', name: 'Confusing Words & Homophones', category_slug: 'verbal-ability' },
  { id: 'spotting-errors', name: 'Spotting Errors', category_slug: 'verbal-ability' },
  { id: 'sentence-correction', name: 'Sentence Correction', category_slug: 'verbal-ability' },
  { id: 'sentence-improvement', name: 'Sentence Improvement', category_slug: 'verbal-ability' },
  { id: 'change-of-voice', name: 'Change of Voice', category_slug: 'verbal-ability' },
  { id: 'change-of-speech', name: 'Change of Speech', category_slug: 'verbal-ability' },
  ...
  { id: 'sentence-formation', name: 'Sentence Formation', category_slug: 'verbal-ability' },
  { id: 'paragraph-formation', name: 'Paragraph Formation', category_slug: 'verbal-ability' },
  { id: 'completing-statements', name: 'Completing Statements', category_slug: 'verbal-ability' },
  { id: 'selecting-words', name: 'Selecting Words', category_slug: 'verbal-ability' },
  { id: 'double-fillers', name: 'Double Fillers & Connectors', category_slug: 'verbal-ability' },
  ...
  { id: 'verbal-analogies', name: 'Verbal Analogies', category_slug: 'verbal-ability' },

  // ── 6. Nonverbal Reasoning (12 Topics) ──
  { id: 'pattern-completion', name: 'Visual Series & Pattern Completion', category_slug: 'non-verbal-reasoning' },
  { id: 'mirror-images', name: 'Mirror & Water Images', category_slug: 'non-verbal-reasoning' },
  { id: 'water-images', name: 'Water Images', category_slug: 'non-verbal-reasoning' },
  { id: 'paper-folding', name: 'Paper Folding & Cutting', category_slug: 'non-verbal-reasoning' },
  { id: 'paper-cutting', name: 'Paper Cutting', category_slug: 'non-verbal-reasoning' },
  { id: 'figure-matrix', name: 'Figure Matrix', category_slug: 'non-verbal-reasoning' },
  { id: 'rule-detection', name: 'Rule Detection', category_slug: 'non-verbal-reasoning' },
  { id: 'dot-situation', name: 'Dot Situation', category_slug: 'non-verbal-reasoning' },
  { id: 'embedded-images', name: 'Embedded Images', category_slug: 'non-verbal-reasoning' },
  { id: 'counting-of-figures', name: 'Counting of Figures', category_slug: 'non-verbal-reasoning' },
  { id: 'grouping-of-images', name: 'Grouping of Identical Figures', category_slug: 'non-verbal-reasoning' },
  { id: 'shape-construction', name: 'Shape Construction & Reconstruction', category_slug: 'non-verbal-reasoning' },
  { id: 'nonverbal-analogy', name: 'Nonverbal Analogy', category_slug: 'non-verbal-reasoning' },
  { id: 'nonverbal-classification', name: 'Nonverbal Classification', category_slug: 'non-verbal-reasoning' },
  ...
  { id: 'pseudocode-tracing', name: 'Pseudocode & Variable Tracing', category_slug: 'technical-aptitude' },
  { id: 'bitwise-operators', name: 'Bitwise Operators & Logic', category_slug: 'technical-aptitude' },
  { id: 'recursion-functions', name: 'Recursion & Function Scope', category_slug: 'technical-aptitude' },
  { id: 'attention-to-detail', name: 'Attention to Detail & Visual Checking', category_slug: 'technical-aptitude' },
  { id: 'code-debugging-logic', name: 'Code Debugging & Automata Fix', category_slug: 'technical-aptitude' },
  { id: 'cloud-networking-basics', name: 'General Tech, OS & Cloud Basics', category_slug: 'technical-aptitude' },
