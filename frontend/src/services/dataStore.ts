...
class DataStoreManager {
  ...
  parseTopicQuestionJsonItem(raw: any, defaultTopicId?: string): Partial<TopicQuestionItem> {
    ...
    // 10. STRUCTURED OPTIONS FORMAT ({ id: "A", text: "..." })
    ...
    // 9. DIFFICULTY LEVEL NUMERICAL (1 = Easy, 2 = Medium, 3 = Hard)
    ...
    // 2. EXPLANATION: KEEP structuredExplanation AS SOURCE OF TRUTH (DO NOT FLATTEN)
    ...
    // 6, 7, 8. VERSION, STATUS, & AI METADATA
    ...
    const parsedItem: Partial<TopicQuestionItem> = {
      ...
      structuredExplanation, // SOURCE OF TRUTH
      formulasUsed,
      difficultyLevel,
      difficulty: difficultyLevel === 1 ? 'EASY' : difficultyLevel === 3 ? 'HARD' : 'MEDIUM',
      status,
...
// 4. SHA-256 Fixed Hex Hash Generator
