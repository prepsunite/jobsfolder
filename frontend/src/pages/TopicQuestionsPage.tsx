      ...
      {showModal && (
        <div className="fixed inset-0 z-50 bg-[#000000]/60 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white dark:bg-[#1e1f22] border border-[#E9ECEF] dark:border-[#2b2d31] rounded-[24px] max-w-2xl w-full p-6 space-y-5 shadow-2xl animate-fadeIn max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between pb-3 border-b border-[#E9ECEF] dark:border-[#2b2d31]">
              <div className="flex items-center gap-2 text-[#121417] dark:text-[#FD4A32]">
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                  <div className="flex items-center gap-2">
                    <span className="font-black text-xs w-5 text-[#121417] dark:text-[#FD4A32]">A.</span>
                    <input
                      type="text"
                      value={formOptionA}
                  ...
                  <div className="flex items-center gap-2">
                    <span className="font-black text-xs w-5 text-[#121417] dark:text-[#FD4A32]">B.</span>
                    <input
                      type="text"
                      value={formOptionB}
                  ...
                  <div className="flex items-center gap-2">
                    <span className="font-black text-xs w-5 text-[#121417] dark:text-[#FD4A32]">C.</span>
                    <input
                      type="text"
                      value={formOptionC}
                  ...
                  <div className="flex items-center gap-2">
                    <span className="font-black text-xs w-5 text-[#121417] dark:text-[#FD4A32]">D.</span>
                    <input
                      type="text"
                      value={formOptionD}
                  ...
                  <div className="flex items-center gap-2 sm:col-span-2">
                    <span className="font-black text-xs w-5 text-[#121417] dark:text-[#FD4A32]">E.</span>
                    <input
                      type="text"
                      value={formOptionE}
