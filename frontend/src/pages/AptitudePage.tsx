...
export const ARITHMETIC_TOPICS: AptitudeTopic[] = [
  ...
  { id: 'hcf-lcm', name: 'Problems on H.C.F and L.C.M', cluster: 'Number System', icon: Grid, description: 'Highest Common Factor and Least Common Multiple applications.', count: 32, formulas: ['Product of two numbers = HCF × LCM', 'HCF of fractions = HCF of numerators / LCM of denominators', 'LCM of fractions = LCM of numerators / HCF of denominators'] },
