            ...
            <div className="text-center py-12 space-y-2">
              ...
              {isAdmin && (
                <button
                  ...
                  className="mt-2 px-3 py-1.5 rounded-lg bg-black/5 hover:bg-black/10 dark:bg-[#FD4A32]/10 dark:hover:bg-[#FD4A32]/20 text-[#121417] dark:text-[#FD4A32] text-xs font-display font-bold transition-all cursor-pointer border border-[#E9ECEF] dark:border-[#FD4A32]/20"
                >
