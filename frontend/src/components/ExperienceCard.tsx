...
export default function ExperienceCard({ experience }: ExperienceCardProps) {
  return (
    <div className="bg-[#ffffff] dark:bg-[#1e1f22] hover:bg-[#fff8f5] dark:hover:bg-[#2b2d31] border border-[#eae1da] dark:border-[#383a40] hover:border-[#006c49]/40 dark:hover:border-[#6cf8bb]/40 rounded-[24px] p-6 transition-all duration-300 space-y-4 shadow-sm">
      {/* Header Info */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4 border-b border-[#eae1da] dark:border-[#2b2d31]">
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-bold uppercase tracking-wider px-3 py-0.5 rounded-full bg-[#6cf8bb]/30 dark:bg-[#006c49]/30 text-[#00714d] dark:text-[#6cf8bb] border border-[#00714d]/20 dark:border-[#6cf8bb]/20">
          ...
          <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-[#444748] dark:text-[#a6adbb]">
            <span className="flex items-center gap-1 font-semibold text-[#1f1b17] dark:text-[#e3e3e3]">
              <UserCheck className="w-3.5 h-3.5 text-[#006c49] dark:text-[#6cf8bb]" />
      ...
      {experience.tips && (
        <div className="p-4 bg-[#f6ece6] dark:bg-[#141517] border border-[#e2d8d2] dark:border-[#2b2d31] rounded-[16px] text-xs text-[#1f1b17] dark:text-[#e3e3e3] space-y-1">
          <div className="flex items-center gap-1.5 font-bold text-[#006c49] dark:text-[#6cf8bb]">
