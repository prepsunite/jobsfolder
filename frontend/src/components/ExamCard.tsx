...
export default function ExamCard({ exam, onEdit, onDelete }: ExamCardProps) {
  ...
  return (
    <div className="group relative bg-white dark:bg-[#141414] border border-[#E9ECEF] dark:border-[#242424] rounded-lg p-3.5 transition-all duration-200 hover:border-[#121417] dark:hover:border-[#383838] hover:shadow-sm flex flex-col justify-between">
      ...
      <div className="relative rounded-md bg-[#F8F9FA] dark:bg-[#0C0C0C] p-3 flex flex-col items-center justify-center min-h-[150px] overflow-hidden border border-[#E9ECEF] dark:border-[#242424] space-y-2">
        {/* Exam Title */}
        <h3 className="font-display text-xs font-bold text-[#121417] dark:text-[#FFFFFF] tracking-tight group-hover:text-[#009D63] dark:group-hover:text-[#00C47B] transition-colors line-clamp-2 text-center z-10">
          {exam.name}
        </h3>

        {/* Center Main Visual Logo */}
        <div className="my-auto flex items-center justify-center w-full h-24 rounded-md border border-[#E9ECEF] dark:border-[#242424] overflow-hidden bg-white dark:bg-[#141414]">
          {exam.companyLogoUrl ? (
            <img
            ...
            <div className="flex items-center justify-center gap-1 group-hover:scale-105 transition-transform duration-200">
              <div className="w-9 h-9 rounded-md bg-[#F1F3F5] dark:bg-[#1C1C1C] border border-[#E9ECEF] dark:border-[#2E2E2E] text-[#121417] dark:text-[#FFFFFF] flex items-center justify-center font-display text-base font-black">
      ...
      <div className="pt-2.5 px-0.5 flex items-center justify-between gap-2 border-t border-[#E9ECEF] dark:border-[#242424] mt-2.5">
        {/* Left: Handle & Industry Metadata */}
        <div className="min-w-0">
          <div className="text-[11px] font-display font-bold text-[#121417] dark:text-[#FFFFFF] truncate">
            {exam.companyName}
          </div>
          <div className="text-[9px] text-[#868E96] dark:text-[#555555] truncate flex items-center gap-1">
        ...
        <Link
          ...
          className="inline-flex items-center gap-1 px-2.5 py-1.5 rounded-md bg-[#121417] dark:bg-white text-white dark:text-black hover:bg-[#009D63] dark:hover:bg-[#00C47B] font-display font-bold text-[9px] uppercase tracking-wider transition-colors shrink-0"
